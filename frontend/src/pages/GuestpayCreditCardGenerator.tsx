...
const CARD_BINS: Record<string, string[]> = {
  Visa:             ['411111', '424242', '426684', '453978', '476173'],
  Mastercard:       ['521234', '530000', '541333', '555555'],
  Discover:         ['601100', '601120', '650028'],
  'American Express': ['371449', '378282', '378734'],
}
const CARD_LENGTHS: Record<string, number> = {
  Visa: 16, Mastercard: 16, Discover: 16, 'American Express': 15,
}
...
const GuestpayCreditCardGenerator: React.FC = () => {
  ...
  const downloadCards = () => {
    ...
    const a    = document.createElement('a'); a.href = url; a.download = 'guestpay-test-cards.txt'; a.click()
          ...
          <div className="w-64 flex-shrink-0 bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex flex-col gap-5">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[9px] text-slate-400 leading-tight mt-0.5">Guestpay Credit Card Generator</p>
              </div>
            </div>
              ...
              <div className="flex-1 flex flex-col bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                ...
                <div className="px-6 py-4 border-b border-slate-100 flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">Your randomly generated Guestpay test cards are ready</p>
                    {generatedAt && (
            ...
            <div className="p-8">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Guestpay Credit Card Generator · Error</p>
                </div>
              </div>
...
export default GuestpayCreditCardGenerator
